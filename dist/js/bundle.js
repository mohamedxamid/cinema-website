...
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../modules/cards */ "./src/modules/cards.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])("2024-01-01");
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    ...
    _createClass(MenuCard, [{
      ...
      value: function render() {
        ...
        element.innerHTML = "\n            <img class=\"plans__img\" src=".concat(this.src, " alt=").concat(this.alt, " width=\"318.4\" height=\"200\">\n            <div class=\"plans__content\">\n            <div class=\"plans__name\">Plan \"").concat(this.title, "\"</div>\n            <p class=\"plans__desc\">").concat(this.desc, "</p>\n            </div>\n            <div class=\"plans__price\">\n            <div class=\"plans__cost\">Price:</div>\n            <div class=\"plans__total\"><span>").concat(this.price, "</span> uzs/month</div>\n            </div>\n            ");
  ...
  // Request
  axios.get('http://localhost:3000/menu').then(function (_ref) {
    var data = _ref.data;
...
/* harmony import */ var _js_main__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../js/main */ "./src/js/main.js");
/* harmony import */ var _js_server_server__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../js/server/server */ "./src/js/server/server.js");
...
function form() {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (evt) {
      ...
      (0,_js_server_server__WEBPACK_IMPORTED_MODULE_11__.postData)("http://localhost:3000/requests", json).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    var elPrevModal = document.querySelector('.modal__inner'),
      elModalContainer = document.querySelector('.modal__container');
    elPrevModal.classList.add(_js_main__WEBPACK_IMPORTED_MODULE_10__.modifiers.hide);
    var elThanksModal = document.createElement('div');
    elThanksModal.classList.add('modal__inner');
    elThanksModal.innerHTML = "\n        <button class=\"modal__close\" type=\"button\">&times;</button>\n        <div class=\"modal__text\">".concat(message, "</div>\n        ");
    elModalContainer.append(elThanksModal);
    setTimeout(function () {
      elThanksModal.remove();
      elPrevModal.classList.remove(_js_main__WEBPACK_IMPORTED_MODULE_10__.modifiers.hide);
      (0,_modal__WEBPACK_IMPORTED_MODULE_9__.closeModal)();
    }, 4000);
  }
}
...
/* harmony import */ var _js_main__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../js/main */ "./src/js/main.js");





var elsOpenModal = document.querySelectorAll('.js-open-modal'),
  elModal = document.querySelector('.modal'),
  openModalTimerId = setTimeout(openModal, 5000);
function closeModal() {
  elModal.classList.add(_js_main__WEBPACK_IMPORTED_MODULE_4__.modifiers.hide);
  document.body.style.overflow = "";
}
function openModal() {
  elModal.classList.remove(_js_main__WEBPACK_IMPORTED_MODULE_4__.modifiers.hide);
  document.body.style.overflow = "hidden";
  clearTimeout(openModalTimerId);
}
function modal() {
  closeModal();
  elsOpenModal.forEach(function (elOpenModal) {
  ...
  document.addEventListener('keydown', function (evt) {
    if (evt.code === "Escape" && !elModal.classList.contains(_js_main__WEBPACK_IMPORTED_MODULE_4__.modifiers.hide)) {
      closeModal();
    }
    ;
  });
...
/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./timer */ "./src/modules/timer.js");
...
function slider() {
  var elsSliderContent = document.querySelectorAll('.slider__content'),
  ...
  elsSliderContent.forEach(function (elSliderContent) {
    elSliderContent.style.width = elSliderWrapperWidth;
  });
  elIndicators.innerHTML = renderIndicators();
  var elsDotsBtn = elIndicators.querySelectorAll('.slider__indicators-btn');
  var slideIndex = 0;
  ...
  elsDotsBtn.forEach(function (elDotsBtn) {
    elDotsBtn.addEventListener('click', function (evt) {
  ...
  function renderIndicators() {
    var text = "";
    for (var i = 0; i < elsSliderContent.length; i++) {
      text += "<li class=\"slider__indicators-item\"><button class=\"slider__indicators-btn\" data-slide-to=\"".concat(i, "\"></button></li>");
    }
    return text;
  }
  function showSlide(idx) {
    elSliderField.style.transform = "translateX(-".concat(+elSliderWrapperWidth.replace(/(r?em|px|\%)$/g, '') * idx, "px)");
    changeInfo();
    changeIndicator();
  }
  ...
  function changeInfo() {
    elSLiderTotal.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(elsSliderContent.length);
    elSLiderCurrent.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_5__.getZero)(slideIndex + 1);
  }
...
function tabs() {
  var elTabsNavigationList = document.querySelector('.tabs__navigation-list');
  deactivateTabLinks();
  activeTabContent();
  if (elTabsNavigationList) {
    elTabsNavigationList.addEventListener('click', function (evt) {
      if (evt.target && evt.target.matches('.tabs__natigation-item')) {
        var elsTabsNavigationItem = document.querySelectorAll('.tabs__natigation-item');
        elsTabsNavigationItem.forEach(function (item, index) {
          if (evt.target === item) {
            deactivateTabLinks();
  ...
  function activeTabContent() {
    ...
    var elsTabsNavigationItem = document.querySelectorAll('.tabs__natigation-item');
    var elsTabsContent = document.querySelectorAll('.tabs__content');
    elsTabsNavigationItem[i].classList.add(_js_main__WEBPACK_IMPORTED_MODULE_3__.modifiers.tabsNavigationItemActive);
    elsTabsContent[i].classList.add(_js_main__WEBPACK_IMPORTED_MODULE_3__.modifiers.show, _js_main__WEBPACK_IMPORTED_MODULE_3__.modifiers.fade);
    elsTabsContent[i].classList.remove(_js_main__WEBPACK_IMPORTED_MODULE_3__.modifiers.hide);
  }
  function deactivateTabLinks() {
    var elsTabsNavigationItem = document.querySelectorAll('.tabs__natigation-item');
    var elsTabsContent = document.querySelectorAll('.tabs__content');
    elsTabsNavigationItem.forEach(function (item) {
      item.classList.remove(_js_main__WEBPACK_IMPORTED_MODULE_3__.modifiers.tabsNavigationItemActive);
    });
    elsTabsContent.forEach(function (item) {
      item.classList.add(_js_main__WEBPACK_IMPORTED_MODULE_3__.modifiers.hide);
      item.classList.remove(_js_main__WEBPACK_IMPORTED_MODULE_3__.modifiers.show, _js_main__WEBPACK_IMPORTED_MODULE_3__.modifiers.fade);
    });
  }
}
...
function timer(deadline) {
  var elPromotionDate = document.querySelector('.promotion__date');
  elPromotionDate.innerHTML = getDate(deadline);
  setClock('.promotion__timer', deadline);
  function getTimeRemaining(endtime) {
    var totalSeconds, totalMinutes, totalHours, days, seconds, minutes, hours;
    ...
    if (timer <= 0) {
      ...
      totalSeconds = Math.floor(timer / 1000), totalMinutes = Math.floor(totalSeconds / 60), totalHours = Math.floor(totalMinutes / 60), days = Math.floor(totalHours / 24), seconds = Math.floor(totalSeconds % 60), minutes = Math.floor(totalMinutes % 60), hours = Math.floor(totalHours % 24);
    }
    return {
      timer: timer,
      seconds: seconds,
  ...
  function getDate(date) {
    ...
    return "".concat(month, " ").concat(new Date(date).getDate());
  }
}
